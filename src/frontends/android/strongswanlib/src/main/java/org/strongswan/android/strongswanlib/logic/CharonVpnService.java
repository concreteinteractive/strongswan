...
package org.strongswan.android.strongswanlib.logic;
...
import org.strongswan.android.strongswanlib.BuildConfig;
...
public class CharonVpnService extends VpnService implements Runnable
{
	...
	public class BuilderAdapter
	{
		...
		private VpnService.Builder createBuilder(String name)
		{
			...
			Intent intent = new Intent(context, configurationActivityClass);
